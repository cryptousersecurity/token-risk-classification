...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE = #TETRAMOON

   #TETRAMOON features:
   5% fee auto add to the liquidity pool to locked forever when selling
   5% fee auto distribute to all holders
   I created a black hole so #TETRAMOON token will deflate itself in supply with every transaction
...
contract TetraMoon is Context, IERC20, Ownable {
    ...
    string private _name = "TetraMoon";
    string private _symbol = "TETRAMOON";
