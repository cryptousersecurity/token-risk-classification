...
contract JackDawCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 800e6 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 40_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 800_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 800_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 800_000_000 * 10**_decimals;

    address public marketingAddress = 0x7Dafb7ba8e998C576C5bE5B2ee2e299A45c595AB;
    address public devAddress = 0x7Dafb7ba8e998C576C5bE5B2ee2e299A45c595AB;

    string private constant _name = "JackDawCoin";
    string private constant _symbol = "$JDAW";
    ...
    Taxes public taxes = Taxes(0,0,3,2);
    Taxes public sellTaxes = Taxes(0,0,3,2);
    ...
    // Owner cannot transfer out $JDAW from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out $JDAW!");
