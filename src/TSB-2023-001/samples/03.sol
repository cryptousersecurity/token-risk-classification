...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #LeveragedPig

    I make this #LeveragedPig to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/LeveragedPigBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LeveragedPig to the community, make sure it's 100% safe.

   I will add 0.8 BNB and all the left 49.5% total supply to the pool
   Can you make #LeveragedPig 10000000X? 
   ...
   it's the best part of the #LeveragedPig idea, increasing the liquidity pool automatically, 
...
contract LeveragedPig is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "LeveragedPig";
  string private _name = "LeveragedPig";
