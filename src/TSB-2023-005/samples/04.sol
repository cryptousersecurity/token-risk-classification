...
/**
  ...
  Welcome to ChukelonDoge! ⚡️🚀⚡️

  We bet DOGE will be the STAR of 2022, so we already are buying our DOGE!
  The token will give BEP-20 Doge every 30 minutes to all holders based on how many tokens they hold.

  https://t.me/ChukelonDogeBSC
...
contract ChukelonDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ChukelonDoge";
    string constant _symbol = "ChukelonDoge";
