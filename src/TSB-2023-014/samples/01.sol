...
contract Lebrainu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lebra Inu"; //
    string private constant _symbol = "Lebra"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x925d0CD4694577b48008A5E3586E84d4313DCBD8 ;
