...
/**
EAGLEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE

THE EAGLE WILL NEVER LAND!

Welcome to Eagle Inu, the low tax, community-driven coin that is primed to soar higher and higher and higher!  Forget the sad state of the current market.  Eagles prey on bears, after all.  Come take that leap of faith with us and we’ll fly together to heights undreamt of!
...
TG: http://t.me/eagleinubsc
Twitter: https://twitter.com/Eagleinu_bsc
...
contract eagleinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Eagle Inu";
